...
# grouped_ts_1_2 = explain_temporal(f"conf9000/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,1], [0,1], subject, 0)
# grouped_ts_1_2r = explain_temporal(f"conf9000/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,1], [0,1], subject, 1)

# print("SelfStim vs SelfRest")
# grouped_ts_1_3 = explain_temporal(f"conf9001/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,2], [0,1], subject, 0)
# grouped_ts_1_3r = explain_temporal(f"conf9001/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,2], [0,1], subject, 1)

# print("SelfStim vs CtrlRest")
# grouped_ts_1_4 = explain_temporal(f"conf9002/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,3], [0,1], subject, 0)
# grouped_ts_1_4r = explain_temporal(f"conf9002/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [0,3], [0,1], subject, 1)
...
# grouped_ts_2_3 = explain_temporal(f"conf9005/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [1,2], [0,1], subject, 0)
# grouped_ts_2_3r = explain_temporal(f"conf9005/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [1,2], [0,1], subject, 1)

# print("CtrlStim vs CtrlRest")
# grouped_ts_2_4 = explain_temporal(f"conf9006/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [1,3], [0,1], subject, 0)
# grouped_ts_2_4r = explain_temporal(f"conf9006/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [1,3], [0,1], subject, 1)
...
# grouped_ts_3_4 = explain_temporal(f"conf9009/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [2,3], [0,1], subject, 0)
# grouped_ts_3_4r = explain_temporal(f"conf9009/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [2,3], [0,1], subject, 1)
...
# grouped_ts_5_6 = explain_temporal(f"conf9014/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [4,5], [0,1], subject, 0)
# grouped_ts_5_6r = explain_temporal(f"conf9014/checkpoint_{subject:02d}_00.ckpt", "D:\\Donnees\\Documents\\insa\\5IF\\PSAT\\CNN1D\\data\\video\\All_Subs_Diff_Modules_nofilter_withoutAUc.csv", [4,5], [0,1], subject, 1)
